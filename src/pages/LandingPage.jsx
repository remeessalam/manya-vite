...
const LandingPage = ({ page }) => {
  ...
  return (
    <>
      ...
      <section
        id="banner"
        className="sm:h-screen relative text-white sm:pt-0  "
      >
        ...
        <img
         ...
         1200px"
          ...
          alt="langing-page-banner-image"
        />
        <div
          data-aos="fade-up"
          className="wrapper text-center flex flex-col gap-5 justify-center items-center h-full relative z-10 pt-[10rem] pb-[6rem]"
        >
          <p className="text-xl">
            Welcome to{" "}
            <span className="text-primary font-semibold">MANYA AI</span>
          </p>

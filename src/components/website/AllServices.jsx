          ...
          >
            <div className="flex flex-col items-center">
              <div className="bg-tertiary group-hover:bg-secondary p-4 aspect-square rounded-full">
                <service.icon className="group-hover:text-white h-[3.5rem] md:h-[4rem] object-contain text-4xl mx-auto group-hover:scale-110 duration-300 transition-all" />
              </div>
              {/* <img
                loading="lazy"
                src={service.icon}
              ...
              <p className="desc mt-2">{service.desc}</p>
            </div>
            <Link
